...
async function seed() {
    ...
    try {
        ...
        const adminUsers = await client_1.db.select().from(schema_1.users).limit(1);
        ...
        // 2. Buat Field Dummy
        const fieldId = (0, crypto_1.randomUUID)();
        await client_1.db.insert(schema_1.fields).values({
            id: fieldId,
        ...
        const sb1Id = (0, crypto_1.randomUUID)();
        const sb2Id = (0, crypto_1.randomUUID)();
    ...
    `);
        // 4. Buat Devices
        const dev1Id = (0, crypto_1.randomUUID)();
        await client_1.db.insert(schema_1.devices).values({
            id: dev1Id,
            fieldId: fieldId,
        ...
        await client_1.db.insert(schema_1.deviceAssignments).values({
            deviceId: dev1Id,
            subBlockId: sb1Id,
            fieldId: fieldId,
        }).onConflictDoNothing();
        ...
        const rec1Id = (0, crypto_1.randomUUID)();
        ...
        const rec2Id = (0, crypto_1.randomUUID)();
        await client_1.db.insert(schema_1.irrigationRecommendations).values({
            id: rec2Id,
            fieldId: fieldId,
            subBlockId: sb2Id,
