import { Ct as isEmpty, X as containsExtent, Y as containsCoordinate, _ as fromUserExtent, bt as getWidth, gt as getIntersection, ht as getHeight, xt as intersects } from "./proj-D-3_6tUI.js";
import { n as compose, t as apply } from "./transform-CoOA6CVp.js";
import { t as ImageState_default } from "./ImageState-C1Vcd1S9.js";
import { f as ViewHint_default } from "./View-Dgi0o1i3.js";
import { t as Layer } from "./Layer-BJLVwGwo.js";
import { t as CanvasLayerRenderer } from "./Layer-BzXNRZwL.js";
//#region node_modules/ol/renderer/canvas/ImageLayer.js
/**
...
* @api
*/
var CanvasImageLayerRenderer = class extends CanvasLayerRenderer {
	/**
	...
	*/
	prepareFrame(frameState) {
		...
		if (layerState.extent !== void 0) renderedExtent = getIntersection(renderedExtent, fromUserExtent(layerState.extent, viewState.projection));
		if (!hints[ViewHint_default.ANIMATING] && !hints[ViewHint_default.INTERACTING] && !isEmpty(renderedExtent)) if (imageSource) {
			if (!this.getLayer().rendered && this.renderedSourceRevision_ !== imageSource.getRevision()) this.image = null;
...
//#endregion
//#region node_modules/ol/layer/BaseImage.js
/**
...
* @api
*/
var BaseImageLayer = class extends Layer {
	/**
...
//#endregion
//#region node_modules/ol/layer/Image.js
/**
...
* @api
*/
var ImageLayer = class extends BaseImageLayer {
	/**
